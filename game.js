...
class TrainGame {
    constructor(canvasId) {
        ...
        this.paused = false;
        this.boostTokens = [];  // timestamps of boost taps; each lasts 1 s, uncapped stack
    ...
    update(deltaTime) {
        ...
        // Active boost tokens: each tap gives +5 % for 1 s (no hold-stacking)
        const now = Date.now();
